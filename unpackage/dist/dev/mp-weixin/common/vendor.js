...
const tabBar = {
  color: "#c0b193",
  selectedColor: "#ff9901",
  borderStyle: "white",
  list: [
    {
      pagePath: "pages/story/index",
      text: "故事",
      iconPath: "/static/故事.png",
      selectedIconPath: "/static/故事(1).png"
    },
    {
      pagePath: "pages/ask/index",
      text: "问答",
      iconPath: "/static/问答.png",
      selectedIconPath: "/static/问答(1).png"
    },
    {
...
const globalStyle = {
  ...
  navigationBarTitleText: "uni-app",
  navigationBarBackgroundColor: "#fefcf6",
...
const S = true, b = "mp-weixin", A = I([]), P = b, T = I(""), C = I('[{"provider":"aliyun","spaceName":"show","spaceId":"mp-4e1f0d27-0434-4947-9512-6194e7bc60a5","clientSecret":"F8OFbjYZZxUbLQ742+SQPw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__30F8F00";
} catch (e2) {
